        ...
        <>
            ...
            >
                <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                    ...
                    <p className="mb-8 text-lg font-normal lg:text-xl sm:px-16 xl:px-48 text-gray-200"> At PixelForge I connect you with free pixel art fonts and AI models created by talented artists and shared for everyone, so you can find what you need to craft your games.</p>
