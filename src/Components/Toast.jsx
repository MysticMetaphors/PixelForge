export default function Toast({header, content}) {
    ...
    return (
        <div id="toast-warning" className="fixed bottom-[10px] right-[10px] flex w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow-sm dark:text-gray-400 dark:bg-gray-800 animate-fade" role="alert">
            ...
            <div className="ms-3 text-sm font-normal text-justify"><strong>{header}</strong><br />{content}</div>
